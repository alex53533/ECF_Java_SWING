...
public class Proprietaire extends Personne {
    ...
    public Proprietaire(String nom_personne, String prenom_personne, String email_personne, int num_licence, int annee_licence, String nom_club) {
        super(nom_personne, prenom_personne, email_personne, num_licence, annee_licence, nom_club);
    }
